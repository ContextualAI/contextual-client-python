...
class TestContextualAI:
    ...
    def test_hardcoded_query_params_in_url(self, client: ContextualAI) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload(self, respx_mock: MockRouter, client: ContextualAI) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload_with_body_is_deprecated(self, respx_mock: MockRouter, client: ContextualAI) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    def test_retries_taken(
        ...
        response = client.agents.with_raw_response.create(name="xxx")
    ...
    def test_omit_retry_count_header(
        ...
        response = client.agents.with_raw_response.create(name="xxx", extra_headers={"x-stainless-retry-count": Omit()})
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.agents.with_raw_response.create(name="xxx", extra_headers={"x-stainless-retry-count": "42"})
...
class TestAsyncContextualAI:
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncContextualAI) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_binary_content_upload(self, respx_mock: MockRouter, async_client: AsyncContextualAI) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    async def test_retries_taken(
        ...
        response = await client.agents.with_raw_response.create(name="xxx")
