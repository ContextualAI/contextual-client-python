...
from sunrise.types.applications.tune import GetTuneJobResponse
...
class TestMetadata:
    ...
    def test_method_retrieve(self, client: Sunrise) -> None:
        metadata = client.applications.tune.jobs.metadata.retrieve(
    ...
    def test_raw_response_retrieve(self, client: Sunrise) -> None:
        response = client.applications.tune.jobs.metadata.with_raw_response.retrieve(
            job_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            application_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_retrieve(self, client: Sunrise) -> None:
        with client.applications.tune.jobs.metadata.with_streaming_response.retrieve(
            job_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            application_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Sunrise) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `application_id` but received ''"):
            client.applications.tune.jobs.metadata.with_raw_response.retrieve(
                job_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                application_id="",
            )
...
class TestAsyncMetadata:
    ...
    async def test_method_retrieve(self, async_client: AsyncSunrise) -> None:
        metadata = await async_client.applications.tune.jobs.metadata.retrieve(
            job_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            application_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(GetTuneJobResponse, metadata, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncSunrise) -> None:
        response = await async_client.applications.tune.jobs.metadata.with_raw_response.retrieve(
            job_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            application_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncSunrise) -> None:
        async with async_client.applications.tune.jobs.metadata.with_streaming_response.retrieve(
            job_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            application_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_retrieve(self, async_client: AsyncSunrise) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `application_id` but received ''"):
            await async_client.applications.tune.jobs.metadata.with_raw_response.retrieve(
                job_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                application_id="",
            )
