...
from contextual_sdk.types.applications.tune import ListGetTuneJobResponse
...
class TestJobs:
    ...
    def test_method_list(self, client: ContextualAI) -> None:
        job = client.applications.tune.jobs.list(
    ...
    def test_raw_response_list(self, client: ContextualAI) -> None:
        response = client.applications.tune.jobs.with_raw_response.list(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_list(self, client: ContextualAI) -> None:
        with client.applications.tune.jobs.with_streaming_response.list(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
    ...
    def test_path_params_list(self, client: ContextualAI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `application_id` but received ''"):
            client.applications.tune.jobs.with_raw_response.list(
                "",
            )

    @parametrize
    def test_method_delete(self, client: ContextualAI) -> None:
        job = client.applications.tune.jobs.delete(
    ...
    def test_raw_response_delete(self, client: ContextualAI) -> None:
        response = client.applications.tune.jobs.with_raw_response.delete(
            job_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            application_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_delete(self, client: ContextualAI) -> None:
        with client.applications.tune.jobs.with_streaming_response.delete(
            job_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            application_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_delete(self, client: ContextualAI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `application_id` but received ''"):
            client.applications.tune.jobs.with_raw_response.delete(
                job_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                application_id="",
            )
...
class TestAsyncJobs:
    ...
    async def test_method_list(self, async_client: AsyncContextualAI) -> None:
        job = await async_client.applications.tune.jobs.list(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(ListGetTuneJobResponse, job, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncContextualAI) -> None:
        response = await async_client.applications.tune.jobs.with_raw_response.list(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncContextualAI) -> None:
        async with async_client.applications.tune.jobs.with_streaming_response.list(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncContextualAI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `application_id` but received ''"):
            await async_client.applications.tune.jobs.with_raw_response.list(
                "",
            )

    @parametrize
    async def test_method_delete(self, async_client: AsyncContextualAI) -> None:
        job = await async_client.applications.tune.jobs.delete(
            job_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            application_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(object, job, path=["response"])
    ...
    async def test_raw_response_delete(self, async_client: AsyncContextualAI) -> None:
        response = await async_client.applications.tune.jobs.with_raw_response.delete(
            job_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            application_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncContextualAI) -> None:
        async with async_client.applications.tune.jobs.with_streaming_response.delete(
            job_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            application_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_delete(self, async_client: AsyncContextualAI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `application_id` but received ''"):
            await async_client.applications.tune.jobs.with_raw_response.delete(
                job_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                application_id="",
            )
