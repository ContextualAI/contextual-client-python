...
from contextual.types.agents import GetDatasetResponse
...
class TestMetadata:
    ...
    def test_method_retrieve(self, client: ContextualAI) -> None:
        metadata = client.agents.datasets.metadata.retrieve(
    ...
    def test_raw_response_retrieve(self, client: ContextualAI) -> None:
        response = client.agents.datasets.metadata.with_raw_response.retrieve(
            dataset_name="dataset_name",
            agent_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_retrieve(self, client: ContextualAI) -> None:
        with client.agents.datasets.metadata.with_streaming_response.retrieve(
            dataset_name="dataset_name",
            agent_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: ContextualAI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `agent_id` but received ''"):
            client.agents.datasets.metadata.with_raw_response.retrieve(
                dataset_name="dataset_name",
                agent_id="",
            )
...
class TestAsyncMetadata:
    ...
    async def test_method_retrieve(self, async_client: AsyncContextualAI) -> None:
        metadata = await async_client.agents.datasets.metadata.retrieve(
            dataset_name="dataset_name",
            agent_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(GetDatasetResponse, metadata, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncContextualAI) -> None:
        response = await async_client.agents.datasets.metadata.with_raw_response.retrieve(
            dataset_name="dataset_name",
            agent_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncContextualAI) -> None:
        async with async_client.agents.datasets.metadata.with_streaming_response.retrieve(
            dataset_name="dataset_name",
            agent_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_retrieve(self, async_client: AsyncContextualAI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `agent_id` but received ''"):
            await async_client.agents.datasets.metadata.with_raw_response.retrieve(
                dataset_name="dataset_name",
                agent_id="",
            )
