...
class TestEvaluate:
    ...
    def test_method_launch(self, client: ContextualAI) -> None:
        evaluate = client.agents.evaluate.launch(
    ...
    def test_raw_response_launch(self, client: ContextualAI) -> None:
        response = client.agents.evaluate.with_raw_response.launch(
            agent_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            metrics=["equivalence"],
        )
    ...
    def test_streaming_response_launch(self, client: ContextualAI) -> None:
        with client.agents.evaluate.with_streaming_response.launch(
            agent_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            metrics=["equivalence"],
        ) as response:
    ...
    def test_path_params_launch(self, client: ContextualAI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `agent_id` but received ''"):
            client.agents.evaluate.with_raw_response.launch(
                agent_id="",
                metrics=["equivalence"],
            )
...
class TestAsyncEvaluate:
    ...
    async def test_method_launch(self, async_client: AsyncContextualAI) -> None:
        evaluate = await async_client.agents.evaluate.launch(
            agent_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            metrics=["equivalence"],
        )
        assert_matches_type(LaunchEvaluationResponse, evaluate, path=["response"])
    ...
    async def test_raw_response_launch(self, async_client: AsyncContextualAI) -> None:
        response = await async_client.agents.evaluate.with_raw_response.launch(
            agent_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            metrics=["equivalence"],
        )
    ...
    async def test_streaming_response_launch(self, async_client: AsyncContextualAI) -> None:
        async with async_client.agents.evaluate.with_streaming_response.launch(
            agent_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            metrics=["equivalence"],
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_launch(self, async_client: AsyncContextualAI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `agent_id` but received ''"):
            await async_client.agents.evaluate.with_raw_response.launch(
                agent_id="",
                metrics=["equivalence"],
            )
