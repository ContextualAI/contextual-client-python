...
from .....types.applications.tune.list_get_tune_job_response import ListGetTuneJobResponse
...
class JobsResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        return self._get(
            f"/applications/{application_id}/tune/jobs",
    ...
    def delete(
        ...
        *,
        ...
        return self._delete(
            f"/applications/{application_id}/tune/jobs/{job_id}",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=object,
