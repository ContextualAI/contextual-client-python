...
from ....types.applications import tune_create_params
from ....types.applications.tune_response import TuneResponse
    ...
    def create(
        ...
        *,
        ...
        Args:
          ...
          model_id: ID of an existing model to tune. Defaults to the application's default model if
              not specified.
        ...
        return self._post(
            f"/applications/{application_id}/tune",
