...
from ....types.applications.tune.model_list_response import ModelListResponse
...
class ModelsResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        Args:
          application_id: Application ID of the application from which to retrieve tuned models
        ...
        return self._get(
            f"/applications/{application_id}/tune/models",
