...
from .....types.applications.evaluate.evaluation_round_response import EvaluationRoundResponse
...
class MetadataResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/applications/{application_id}/evaluate/jobs/{job_id}/metadata",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=EvaluationRoundResponse,
        )
