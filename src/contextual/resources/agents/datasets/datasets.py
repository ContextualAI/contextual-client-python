...
from ....types.agents import dataset_list_params, dataset_create_params, dataset_update_params, dataset_retrieve_params
from ....types.agents.datasets_response import DatasetsResponse
...
class DatasetsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        Args:
          agent_id: Agent ID to associate with the dataset
    ...
    def retrieve(
        ...
        *,
        ...
        Args:
          agent_id: Agent ID associated with the dataset
        ...
        return self._get(
            f"/agents/{agent_id}/datasets/{dataset_name}",
            options=make_request_options(
    ...
    def list(
        ...
        *,
        ...
        Args:
          agent_id: Agent ID for which to list associated datasets
